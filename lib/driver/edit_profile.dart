...
class _EditProfileState extends State<EditProfile> {
  ...
  void _uploadImage(){
    ...
    final Reference storageReference  = FirebaseStorage.instance.ref().child('Driver').child(imageFileName);
  ...
  void _saveData(String imageUrl){
    FirebaseFirestore.instance.collection("Driver").doc((_auth.currentUser)!.uid)
        .update({
      "imageUrl": imageUrl,
    }).then((_) {
      print("success!");
